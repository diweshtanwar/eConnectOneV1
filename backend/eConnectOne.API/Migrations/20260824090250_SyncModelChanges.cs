        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProblemTypeId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProblemTypeName = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TechnicalDetails_ProblemType_ProblemTypeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, false, "Master Admin" },
                    { 2, null, false, "Admin" },
                    { 3, null, false, "HO user" },
                    { 4, null, false, "CSP" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Dashboard", 1, null },
                    { 2, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "UserManagement", 1, null },
                    { 3, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "TicketManagement", 1, null },
                    { 4, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "AuditLogs", 1, null },
                    { 5, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "SystemSettings", 1, null },
                    { 6, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Dashboard", 2, null },
                    { 7, true, false, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "UserManagement", 2, null },
                    { 8, true, false, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "TicketManagement", 2, null },
                    { 9, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "AuditLogs", 2, null },
                    { 10, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Dashboard", 3, null },
                    { 11, true, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "TicketManagement", 3, null },
                    ...
                    { 14, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "BroadcastManagement", 1, null },
                    { 15, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "CommissionManagement", 1, null },
                    { 16, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Messages", 1, null },
                    { 17, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "ResourceCenter", 1, null },
                    { 18, true, true, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "WalletManagement", 1, null },
                    { 19, true, false, true, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "BroadcastManagement", 2, null },
                    { 20, true, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "CommissionManagement", 2, null },
                    { 21, true, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Messages", 2, null },
                    { 22, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "ResourceCenter", 2, null },
                    { 23, true, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Messages", 3, null },
                    { 24, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "ResourceCenter", 3, null },
                    { 25, true, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Messages", 4, null },
                    { 26, false, false, false, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "ResourceCenter", 4, null }
                });
